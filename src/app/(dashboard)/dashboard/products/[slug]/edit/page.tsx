      ...
      <div className="max-w-screen-xl mx-auto w-full bg-white rounded-lg shadow-md p-6 my-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <textarea
              id="description"
              className="mt-1 p-2 block border bg-white rounded-md w-full border-gray-300 focus:ring-blue-500 focus:border-blue-500"
          ...
          <div>
            ...
            <Input
              id="color"
              className="mt-1 p-2 block border w-full rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500"
          ...
          <div>
            <Label htmlFor="aboutItem" className="block text-sm font-medium text-gray-700">
              About Item
            </Label>
            <textarea
              id="aboutItem"
              className="mt-1 border p-2 block w-full rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500"
              {...register("aboutItem")}
            />
