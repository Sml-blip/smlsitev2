...
function HeroBannerTwo() {
  ...
  return (
    <section className="bg-black text-white lg:py-8">
      <div className="max-w-screen-xl mx-auto relative overflow-hidden py-16 grid grid-cols-1 lg:grid-cols-3 gap-6 p-4 lg:p-8">
          ...
          <div className="flex flex-col-reverse md:flex-row items-center">
            <div className="lg:w-full  text-center md:text-start">
              ...
              <div className="flex items-center justify-center md:justify-start">
                <Link
                  href={`/shop`}
                  className="bg-primary hover:bg-primary/80 text-lg text-black py-4 px-10 rounded-full flex items-center gap-2 font-medium"
                >
        ...
        rounded-md shadow-md space-y-2 py-6 text-center border border-border"
        >
          ...
          <p className="my-4 text-lg font-medium">
            Obtenez jusqu'à <span className="text-primary text-xl font-bold">( 50% de réduction )</span>{" "}
            sur les écouteurs !
          </p>
          <Link
            href={"/shop?category=Headphones"}
            className="py-3 px-8 block w-fit  whitespace-nowrap mx-auto rounded-full bg-primary hover:bg-primary/80
